...
park <<- "SAHI" #assigns to global env. so easier for later code to find
...
```{r results = 'asis', include = F, message = F, warning = F}
html_header <- HTML('
<div class="banner">
  <div class="header">
