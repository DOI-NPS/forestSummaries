...
params:
  report_year: 2026 # year report was generated for
  make_maps: FALSE
---
```{r eval = F, include = F}
#++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++
# 1. This report is was developed when RICH new plots only had 1 cycle of
# data to summarize. 
#++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++
```
...
# NOTE: Once RICH new plots have a second cycle, you should be able to transition to the MIDN-level summaries.
...
park <<- "RICH" #assigns to global env. so easier for later code to find
...
<div class="banner">
  <div class="header">
    ...
    <div id="col-middle-header">
        ...
        <br>
        <h5>', park_title, '- North Anna Unit</h5></div></div></div><br>')
